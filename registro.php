	...
	if(!empty($_POST))
	{
		...
		if(count($errors) == 0)
		{
			...
			if($arr['success'])
			{
				...
				if($registro > 0)
				{				
					$url = 'http://'.$_SERVER["127.0.0.1:3307"].'activar.php?uid='.$registro.'&val='.$token;
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="input-group form-group">								
								<div class="input-group-prepend col-md-12" >
                                    <span class="input-group-text"><i class="fas fa-user fa-3x fa-lg" for="usuario"></i></span>
                            ...
                            <div class="input-group form-group">
                                <div class="input-group-prepend col-md-12">
                                <span class="input-group-text"><i class="fas fa-at fa-3x fa-lg" for="usuario"></i></span>
							...
							<div class="input-group form-group">
                                <div class="input-group-prepend col-md-12">
                                    <span class="input-group-text"><i class="fas fa-key fa-3x fa-lg" for="usuario"></i></span>
